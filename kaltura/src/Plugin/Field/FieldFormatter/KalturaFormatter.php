...
namespace Drupal\kaltura\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'kaltura' formatter.
 *
 * @internal
 ...
 * @FieldFormatter(
 *   id = "kaltura",
 *   label = @Translation("kaltura content"),
 *   field_types = {
 *     "link",
 *     "string",
 *     "string_long",
 ...
 * )
 */
class KalturaFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs an KalturaFormatter instance.
   *
  ...
  public function __construct($plugin_id, $plugin_definition, FieldDefinitionInterface $field_definition, array $settings, $label, $view_mode, array $third_party_settings, MessengerInterface $messenger, ResourceFetcherInterface $resource_fetcher, UrlResolverInterface $url_resolver, LoggerChannelFactoryInterface $logger_factory, ConfigFactoryInterface $config_factory, IFrameUrlHelper $iframe_url_helper) {
    ...
    $this->logger = $logger_factory->get('kaltura');
    $this->config = $config_factory->get('kaltura.settings');
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $container->get('kaltura.kaltura.iframe_url_helper')
    );
  }
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $delta => $item) {
      ...
      elseif ($resource->getType() === Resource::TYPE_PHOTO) {
        ...
        $url = Url::fromRoute('kaltura.kaltura_iframe', [], [
          'query' => [
            'url' => $value,
            'max_width' => $max_width,
        ...
        $element[$delta] = [
          ...
          '#attributes' => [
            ...
            'width' => $max_width ?: $resource->getWidth(),
            'height' => $max_height ?: $resource->getHeight(),
            'class' => ['media-kaltura-content'],
          ],
          '#attached' => [
            'library' => [
              'kaltura/kaltura.formatter',
            ],
          ],
        ];
  ...
  public static function isApplicable(FieldDefinitionInterface $field_definition) {
    ...
    if (parent::isApplicable($field_definition)) {
      ...
      if ($media_type) {
        ...
        return $media_type && $media_type->getSource() instanceof KalturaInterface;
      }
    }
    return FALSE;
  }
